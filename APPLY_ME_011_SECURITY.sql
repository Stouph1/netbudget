-- ============================================================================
-- À APPLIQUER DANS SUPABASE → SQL Editor → New query → coller → Run
--
-- Corrige 5 failles de sécurité trouvées à l'audit du 2026-08-07.
-- Contenu identique à frontend/supabase/migrations/011_security_hardening.sql
--
-- ⚠️ APRÈS avoir lancé ce script, déploie aussi la version à jour de l'app :
--    le client utilise désormais la fonction accept_invite() et la vue
--    member_profiles créées ici.
-- ============================================================================
-- ============================================================================
